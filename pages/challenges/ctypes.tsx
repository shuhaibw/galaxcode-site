        ...
        <div className="bg-gray-100 shadow-md rounded-xl p-6 ">
          ...
          <ol className="list-decimal font-sans list-inside text-gray-800">
            <li className="mt-4">
              ...
              <span className="font-medium  ">Integers (int):</span>
            ...
            {/* big list item */}
            <li className="mt-4">
              <span className="font-medium">Floats (float):</span>
            ...
            <li className="mt-4">
            <span className="font-medium">Strings (str):</span>
            ...
            <li className="mt-4">
            <span className="font-medium">Booleans (bool):</span>
            ...
            <li className="mt-4">
            <span className="font-medium ">Draw a Sun:</span>
              
              <ul className="list-disc ml-8 grid grid-cols-1 gap-1 ">
                <li>
                Use the variables sun_radius and sun_color to draw a sun as a yellow circle
                </li>
              </ul>
             </li>

             <li className="mt-4">
            <span className="font-medium ">End the Program:</span>
