export default function Func(){
   return(
     ...
     bg-purple-900 text-white px-6 py-3  ">
       ...
       <nav className="flex flex-wrap md:pl-20 sm:pl-16 ">
          ...
          <a className ="bg-gray-200 px-2 py-1  rounded-sm text-sm  font-spacemono mr-6 text-gray-700" href="#">Code</a>
      ...
      <div className="bg-white rounded-xl p-6 ">
        ...
        <div className="bg-gray-100 shadow-md rounded-xl p-6 ">
          ...
          <ol className="list-decimal font-sans list-inside text-gray-800">
            ...
            {/* big list item */}
            <li className="mt-4">
              <span className="font-medium">Creating Functions:</span>
              
              <ul className="list-disc ml-8 grid grid-cols-1 gap-1">
                <li>
                Define a function named draw_star to draw a star at the current position of the spaceship.
                </li>
                <div className="ml-6">
                  <li>
                  The star should have 5 points.
                  </li>
                  <li>
                  Each side of the star should be 100 units long.
                  </li>
                </div>
                <li>
                Define a function named draw_planet to draw a planet at the current position of the spaceship.
                </li>
                <div className="ml-6">
                  <li>
                  The planet should have a radius of 50 units.
                  </li>
                </div>
              </ul>
            </li>
            ...
            <li className="mt-4">
              ...
              <ul className="list-disc ml-8 grid grid-cols-1 gap-1">
                ...
                <div className="ml-6">
                  <li>
                  Move the spaceship to the starting position for the star. (Use: spaceship.penup(), spaceship.goto(x, y), spaceship.pendown())
                  </li>
                  <li>
                ...
                <div className="ml-6">
                  <li>
                  Move the spaceship to the starting position for the planet. (Use: spaceship.penup(), spaceship.goto(x, y), spaceship.pendown())
                  </li>
                 <li>Call the draw_planet() function.</li>
                </div>
              </ul>
            </li>
