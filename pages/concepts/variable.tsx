...
<div className="flex">
  <nav className="p-4 border-r border-t border-gray-200  fixed top-18 left-0 h-full overflow-y-auto  w-60 z-10">
    ...
    <ul className="space-y-4">   
      <li><a href="#intro" className="text-violet-700 hover:underline">Intro to Programming</a></li>
      <li><a href="#comment" className="text-violet-700 hover:underline">Comments in Coding</a></li>
      <li><a href="#print" className="text-violet-700 hover:underline">Print Statements</a></li>
      <li><a href="#variables" className="text-violet-700 hover:underline">Variables</a></li>
    </ul>
  </nav>
{/* this w div for inside right side goes to bottom */}
  <div className="w-3/4 ml-60 p-8">
      ...
      <section id="intro" className="mb-12">
          <h1 className="font-orbitron font-bold text-2xl mb-5">Lesson 1: Intro & Variables</h1>
