...
<div className="flex">
  <nav className="p-4 border-r border-t border-gray-200  fixed top-18 left-0 h-full overflow-y-auto  w-60 z-10">
    ...
    <ul className="space-y-4">   
      <li><a href="#intro-functions" className="text-violet-700 hover:underline">Intro to Functions</a></li>
      <li><a href="#create-functions" className="text-violet-700 hover:underline">Create a Function</a></li>
      <li><a href="#practice-functions" className="text-violet-700 hover:underline">Practice Functions</a></li>
    </ul>
  </nav>
