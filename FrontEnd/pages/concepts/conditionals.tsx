         ...
         <div className="flex pt-12">
            <nav className="p-4 border-r  border-gray-200 top-16 fixed  left-0 h-full overflow-y-auto  w-60 z-10">
               ...
               <ul className="space-y-4 text-purple-500">
                  <li><a href="#intro" className=" hover:underline">Intro to If Statements</a></li>
                  <li><a href="#basic" className=" hover:underline">Basic If Statement</a></li>
                  <li><a href="#else" className=" hover:underline">If-Else Statement</a></li>
                  <li><a href="#elif" className=" hover:underline"> If-Elif-Else Statement</a></li>
                  <li><a href="#space-adventure" className=" hover:underline"> Space Adventure!</a></li>
               </ul>
            </nav>
