            ...
            <nav className="p-4 border-r  border-gray-200  fixed top-16 left-0 h-full overflow-y-auto  w-60 z-10">
               <h2 className="font-bold text-lg mb-4 ">Table of Contents</h2>
                  <ul className=" list-none space-y-4 text-purple-500">
                     <li><a href="#integers" className=" hover:underline">Integers</a></li>
                     <li><a href="#floats" className=" hover:underline">Floats</a></li>
                     <li><a href="#strings" className=" hover:underline">Strings</a></li>
                     <li><a href="#booleans" className=" hover:underline">Booleans</a></li>
                     <li><a href="#operations" className=" hover:underline">Data Type Operations</a></li>
                  </ul>
            </nav>
